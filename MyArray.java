 ...
 * arrays. The class include 6 method to solve 4 different problem. This class
 * is demonstrates task1 in lab1.
 * 
 * @author hp
 *
 */
public class MyArray {
	...
	public static void main(String[] args) {
		...
		// This is the testcase of method fillMissingValues.
		int[] array5 = { 10, 11, 12, 13, 14, 16, 17, 19, -1 };
		MyArray ma5 = new MyArray(array5);
		int[] result5 = ma5.fillMissingValues(3); // k=3
		System.out.println("The array printed from fillMissingValues method: " + Arrays.toString(result5));
